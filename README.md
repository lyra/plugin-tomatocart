# PayZen for TomatoCart

PayZen for TomatoCart is an open source plugin that links e-commerce websites based on TomatoCart to PayZen secured payment gateway developped by [Lyra Network](https://www.lyra-network.com/).
